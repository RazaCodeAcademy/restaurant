...
Route::group(['prefix' => 'settings'], function () {
    ...
    //     return env('PAYPAL_CLIENT_ID');
    // });
    Route::post('/set-payment-client-id', [OnlinePaymentController::class, 'store']);
...
Route::group(['prefix' => 'settings', 'middleware' => ['auth:api']], function () {
    ...
    Route::group(['middleware' => ['manage']], function () {
        ...
        Route::post('/update-food-item-enable-disable', [FooditemController::class, 'updateEnableDisable']); //update food-item-variation
