...
class UserWiseController extends Controller
{
    //get by selected user
    public function filter(Request $request)
    {
        ...
        $tempAmount = 0;
        $orderGroups = OrderGroup::where('user_id', $user->id)->where('is_cancelled', 0)
        ...
        return [$userName, $userAmount, $modifiedOrderGroups];
    }
}
