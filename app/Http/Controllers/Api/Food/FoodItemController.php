...
class FoodItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($foods as $food) {
            $temp = new Temporary;
            $temp->id = $food->id;
            $temp->is_enabled = $food->is_enabled;
    ...
    public function updateEnableDisable(Request $request){
        $foodItem = FoodItem::where('slug', $request->slug)->first();
        $foodItem->is_enabled = !$foodItem->is_enabled;
        $foodItem->save();
